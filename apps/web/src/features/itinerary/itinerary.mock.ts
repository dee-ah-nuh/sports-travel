export interface MockEvent {
  ...
  startTime: string;
  endTime?: string;
  venue: { name: string; city: string; nearestIata?: string };
  ...
  return [
    {
      ...
      breakdown: {
        ...
        trainCost: 0,
        hotelCost: 0,
        ...(event.minTicketPrice !== undefined && { ticketCostEstimate: event.minTicketPrice }),
      },
      legs: [
        {
          id: 'l1',
          ...
          carrier: 'Connect Air',
          flightNumber: 'CA 202',
          departureTime: `${dayBefore}T06:00:00Z`,
          arrivalTime: `${dayBefore}T18:00:00Z`,
          durationMinutes: 720,
          stops: 1,
          costEstimate: 310,
          currency: 'USD',
        ...
        { id: 'l2', legOrder: 1, type: 'event', event },
        {
          ...
          carrier: 'Connect Air',
          flightNumber: 'CA 203',
          departureTime: `${eventDate}T23:00:00Z`,
          arrivalTime: `${eventDate}T23:59:00Z`,
          durationMinutes: 720,
          stops: 1,
          costEstimate: 310,
          currency: 'USD',
      ...
      legs: [
        {
          ...
          carrier: 'Direct Air',
          flightNumber: 'DA 101',
          departureTime: `${dayBefore}T08:00:00Z`,
          arrivalTime: `${dayBefore}T16:30:00Z`,
          durationMinutes: 510,
          stops: 0,
          costEstimate: 420,
          currency: 'USD',
        ...
        { id: 'l5', legOrder: 1, type: 'event', event },
        {
          ...
          carrier: 'Direct Air',
          flightNumber: 'DA 102',
          departureTime: `${eventDate}T21:00:00Z`,
          arrivalTime: `${eventDate}T23:59:00Z`,
          durationMinutes: 510,
          stops: 0,
          costEstimate: 420,
      ...
      legs: [
        {
          ...
          carrier: 'Premium Air',
          flightNumber: 'PA 301',
          departureTime: `${dayBefore}T10:00:00Z`,
          arrivalTime: `${dayBefore}T19:00:00Z`,
          durationMinutes: 540,
          stops: 0,
          costEstimate: 365,
          currency: 'USD',
        ...
        { id: 'l8', legOrder: 1, type: 'event', event },
        {
          ...
          carrier: 'Premium Air',
          flightNumber: 'PA 302',
          departureTime: `${eventDate}T22:30:00Z`,
          arrivalTime: `${eventDate}T23:59:00Z`,
          durationMinutes: 580,
          stops: 0,
          costEstimate: 365,
